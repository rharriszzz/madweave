...
function initCoveredByArrays() {
  ...
  for (index=0; index<totalNumber; index++) {
    ...
    var underC = nextM3(thisC);
    var underD = nextM3(thisD);
    var index2;
...
function colorIndex(index) {
  switch (colorPattern) {
  case 0: return getD(index)%cc;
  case 1: return getC(index)%cc;
  case 2: return (getD(index)+getC(index))%cc;

  case 3: return getN(index)%cc;
  case 4: return (getC(index)+getN(index))%cc;
  }
}
var colorIndexArray;
var CIABaseSize;
...
function setHue(evt) {
  ...
  defaultColorButton.setAttribute("fill", newColor);
  colorArray[defaultColorIndex] = newColor;
  buildValueGradient(document, currentHue);
  buildStrips(document);
}
...
function buildStrips(document) {
  ...
  if (colorIndexArray == null || totalNumber != colorIndexArray.length) initColorIndexArray();
...
function setButtonRectColor(buttonRect, colorIndex) {
  ...
  buttonRect.setAttribute("fill", colorArray[colorIndex]);
...
function setStripColorToCurrentDefault(g, index) {
  ...
  reshowStrip(g.ownerDocument, index);
}
...
function addButton(g, locX, locY, dirX, dirY, indexOffset, index, label, name, action) {
  ...
  var rect;
  if (name == "HB" || name == "SVB") widthExpand = 2.0;
  if (-1 < label.indexOf('.')) {
    rect = createSVGElementWithId(document, "image", "button"+name);
...
//addButton(buttons, locX, locY, dirX, dirY, indexOffset, index, label, name, action)
  addButton(buttons, -1,   -1,   0,    1,    0,           0, "a.png", "A", "changeColorPattern(evt.target,0)");
  addButton(buttons, -1,   -1,   0,    1,    0,           1, "b.png", "B", "changeColorPattern(evt.target,1)");
  addButton(buttons, -1,   -1,   0,    1,    0,           2, "c.png", "C", "changeColorPattern(evt.target,2)");
  addButton(buttons, -1,   -1,   0,    1,    0,           3, "d.png", "D", "changeColorPattern(evt.target,3)");
  addButton(buttons, -1,   -1,   0,    1,    0,           4, "e.png", "E", "changeColorPattern(evt.target,4)");

  addButton(buttons, -1,    1,   0,   -1,    0,           5, "1", "CC1", "changeColorCount(evt.target,1)");
  addButton(buttons, -1,    1,   0,   -1,    0,           4, "2", "CC2", "changeColorCount(evt.target,2)");
  addButton(buttons, -1,    1,   0,   -1,    0,           3, "3", "CC3", "changeColorCount(evt.target,3)");
  addButton(buttons, -1,    1,   0,   -1,    0,           2, "4", "CC4", "changeColorCount(evt.target,4)");
  addButton(buttons, -1,    1,   0,   -1,    0,           1, "5", "CC5", "changeColorCount(evt.target,5)");
  addButton(buttons, -1,    1,   0,   -1,    0,           0, "6", "CC6", "changeColorCount(evt.target,6)");

  addButton(buttons,  1,   -1,   0,    1,    0,           0, "1", "1", "setContent(evt.target,1)");
  addButton(buttons,  1,   -1,   0,    1,    0,           1, "2", "2", "setContent(evt.target,2)");
  addButton(buttons,  1,   -1,   0,    1,    0,           2, "4", "4", "setContent(evt.target,4)");
  addButton(buttons,  1,   -1,   0,    1,    0,           3, "6", "6", "setContent(evt.target,6)");

  var bw = (d+sep);
  addButton(buttons,  1-bw,-1,   0,    1,    0,           5, "a", "VC0", "toggleVisibilityC(evt.target,0)");
  addButton(buttons,  1-bw,-1,   0,    1,    0,           6, "b", "VC1", "toggleVisibilityC(evt.target,1)");
  addButton(buttons,  1-bw,-1,   0,    1,    0,           7, "c", "VC2", "toggleVisibilityC(evt.target,2)");

  addButton(buttons,  1+bw,-1,   0,    1,    0,           5, "H", "VD0", "toggleVisibilityD(evt.target,0)");
  addButton(buttons,  1+bw,-1,   0,    1,    0,           6, "R", "VD1", "toggleVisibilityD(evt.target,1)");
  addButton(buttons,  1+bw,-1,   0,    1,    0,           7, "L", "VD2", "toggleVisibilityD(evt.target,2)");
  ...
  addButton(buttons,  0, -1, 1, 0,cbo, 8, "", "HB", "setHue(evt)");
  addButton(buttons,  0, -1, 1, 0,cbo, 9.66, "", "SVB", "setSatValue(evt)");
